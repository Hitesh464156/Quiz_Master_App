  ...
  const fetchResult = async () => {
    try {
      ...
      const { data } = await axios.get(
        `${config.backendURL}/api/v1/quiz/result/${id}`,
        axiosConfig
      );
            ...
            <table className="w-full bg-white dark:bg-gray-700 rounded-lg shadow-lg dark:shadow-gray-950 mb-6 overflow-hidden">
              ...
              <tbody>
                ...
                <tr className="border-b dark:border-gray-600">
                  ...
                  <td className="py-2 px-4">
                    {
                      result.questions.filter((q) => q.isCorrect === "true")
                        .length
                    }
                  </td>
                </tr>
                <tr className="border-b dark:border-gray-600">
                  ...
                  <td className="py-2 px-4">
                    {
                      result.questions.filter((q) => q.isCorrect === "partial")
                        .length
                    }
                  </td>
                </tr>
                  ...
                  <td className="py-2 px-4">
                    {
                      result.questions.filter(
                        (q) => q.isCorrect === "false" && q.answers.length !== 0
                      ).length
                    }
                  </td>
                </tr>
