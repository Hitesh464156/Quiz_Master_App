  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900">
      ...
      <div className="w-[90%] max-w-4xl min-h-[600px] mb-5 p-16 max-sm:p-10 bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-950 flex flex-col items-center justify-center text-gray-700 dark:text-gray-200">
        <h1 className="text-4xl max-sm:text-3xl font-bold text-center mb-6">
          Welcome to QuizMaster!
        </h1>
        <p className="text-lg max-sm:text-base text-justify mb-8">
          Test your knowledge with our fun and engaging quizzes. Whether you're
          looking to challenge yourself or compete with friends, QuizMaster has
          something for everyone. Start a quiz now and see how much you know!
          Create custom quizzes on any topic, share them with your friends, and
          see who can score the highest. Or join a quiz created by others and
          put your skills to the test. From general knowledge to niche subjects,
          there's always something new to learn. Ready to get started? Click
          below to begin your quiz journey!
        </p>
